...
INSERT INTO `categorias` VALUES (1,'Electrónicos','Productos electrónicos como teléfonos, computadoras y accesorios','2024-02-26 07:30:53'),(2,'Ropa','Ropa de moda para hombres, mujeres y niños','2024-02-26 07:30:53'),(3,'Hogar y Jardín','Artículos para el hogar, muebles y suministros de jardinería.','2024-02-26 07:30:53'),(4,'Deportes','Equipos y accesorios para deportes y actividades al aire libre.','2024-02-26 07:30:53'),(5,'Libros','Libros de diversas categorías','2024-02-26 07:30:53'),(6,'Juguetes','Juguetes para niños de todas las edades','2024-02-26 07:30:53'),(7,'Joyería','Joyas y accesorios','2024-02-26 07:30:53'),(8,'Alimentación','Productos alimenticios y gourmet','2024-02-26 07:30:53'),(9,'Salud y Belleza','Productos para el cuidado personal','2024-02-26 07:30:53'),(10,'Automotriz','Accesorios y productos para automóviles','2024-02-26 07:30:53');
...
INSERT INTO `detalle_carrito` VALUES (1,2,35.99,1,1,1,1,4),(2,1,25.50,2,2,2,2,4),(3,3,45.75,3,3,3,3,4),(4,4,80.00,4,4,4,4,4),(5,2,37.98,5,5,5,5,5),(6,1,44.99,6,6,6,6,6),(7,3,90.00,7,7,7,7,7),(8,2,31.50,8,8,8,8,8),(9,1,28.99,9,9,9,9,9),(11,3,29.95,10,NULL,7,NULL,NULL);
...
INSERT INTO `log_productos` VALUES (1,2,'nombre_de_usuario','2024-02-26','07:31:08','before update',NULL,'Camiseta de Algodón','Camiseta de Algodón'),(2,2,'root@localhost','2024-02-26','07:31:08','After update','precio','19.99','23.55');
...
INSERT INTO `log_usuarios` VALUES (1,11,'nuevo_usuario_insertado',NULL,NULL,'2024-02-26','07:31:08');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_update_log_productos` BEFORE UPDATE ON `productos` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_update_producto_log_trigger` AFTER UPDATE ON `productos` FOR EACH ROW BEGIN
...
--
-- Temporary view structure for view `productos_con_promociones`
--

DROP TABLE IF EXISTS `productos_con_promociones`;
/*!50001 DROP VIEW IF EXISTS `productos_con_promociones`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `productos_con_promociones` AS SELECT 
 1 AS `producto_nombre`,
 1 AS `producto_precio`,
 1 AS `category_nombre`,
 1 AS `promocion_nombre`,
 1 AS `promocion_descuento`*/;
SET character_set_client = @saved_cs_client;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_insert_log_usuarios` AFTER INSERT ON `usuarios` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_update_log_usuarios` BEFORE UPDATE ON `usuarios` FOR EACH ROW BEGIN
...
--
/*!50003 DROP FUNCTION IF EXISTS `calcular_descuento_total` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `calcular_descuento_total`(orden_id INT) RETURNS decimal(10,2)
    DETERMINISTIC
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `obtener_historial_compras_por_usuario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `obtener_historial_compras_por_usuario`(usuario_id INT) RETURNS varchar(255) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `obtener_productos_por_categoria` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `obtener_productos_por_categoria`(categoria_nombre VARCHAR(45)) RETURNS varchar(255) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
    DECLARE resultado VARCHAR(255);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `agregar_item_carrito` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `agregar_item_carrito`(
    IN carrito_id INT,
    IN producto_id INT,
    IN cantidad INT,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `calcular_total_orden` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `calcular_total_orden`(IN orden_id INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `eliminar_item_carrito` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `eliminar_item_carrito`(IN carrito_id INT, IN detalle_carrito_id INT)
BEGIN
    DECLARE existe_carrito INT;
...
/*!50001 VIEW `ordenes_pendientes` AS select `o`.`id_orden` AS `id_orden`,`o`.`fecha` AS `order_fecha`,`o`.`estado` AS `order_estado`,`c`.`fecha_creacion` AS `cart_fecha_creacion`,`u`.`nombre` AS `user_nombre`,`u`.`apellido` AS `user_apellido` from ((`ordenes` `o` join `carrito` `c` on((`o`.`id_orden` = `c`.`id_orden`))) join `usuarios` `u` on((`c`.`id_orden` = `u`.`id_usuario`))) where (`o`.`estado` = 'En Proceso') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `productos_con_promociones`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `productos_con_promociones` AS select `pr`.`nombre` AS `producto_nombre`,`pr`.`precio` AS `producto_precio`,`c`.`nombre` AS `category_nombre`,`prom`.`nombre` AS `promocion_nombre`,`prom`.`descuento` AS `promocion_descuento` from ((`productos` `pr` left join `categorias` `c` on((`pr`.`id_categoria` = `c`.`id_categoria`))) left join `promociones` `prom` on(((`pr`.`id_producto` = `prom`.`id_producto`) or (`pr`.`id_categoria` = `prom`.`id_categoria`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_historial_usuario` AS select `u`.`id_usuario` AS `id_usuario`,`u`.`tipo_documento` AS `tipo_documento`,`u`.`numero_documento` AS `numero_documento`,`u`.`nombre` AS `nombre`,`u`.`apellido` AS `apellido`,`u`.`correo` AS `correo`,`u`.`telefono` AS `telefono`,`u`.`fecha_nacimiento` AS `fecha_nacimiento`,`h`.`id_historial` AS `id_historial`,`h`.`fecha` AS `fecha`,`h`.`estado` AS `estado` from (`usuarios` `u` join `historial_compras` `h` on((`u`.`id_usuario` = `h`.`id_usuario`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-02-26 15:43:19
