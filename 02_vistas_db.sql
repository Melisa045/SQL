...
CREATE OR REPLACE VIEW vista_carrito_detalles AS
...
select * FROM vista_carrito_detalles;
...
CREATE OR REPLACE VIEW vista_productos_con_promociones AS
...
select * FROM vista_productos_con_promociones;
